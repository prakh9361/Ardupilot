...
// events for overrun error
static const eventmask_t EVT_OVERRUN_ERR = EVENT_MASK(14);

// events for noise error
static const eventmask_t EVT_NOISE_ERR = EVENT_MASK(15);
